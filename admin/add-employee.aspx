            ...
            <%-- emp pf aw,tax dd,other dd --%>
             <div class="col-md-12  d-flex flex-row mt-3">
                  ...
                  <label for="defaultSelect" class="form-label">Provident Fund</label>
                   <asp:TextBox ID="tb_emp_pf"  CssClass="form-control" runat="server" TextMode="Number"
                     data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" 
             ...
             <div class="col-md-3 d-flex flex-column mt-3 ms-3">
                  ...
                  <label for="defaultSelect" class="form-label">Other Deduction</label>
                   <asp:TextBox ID="tb_emp_other_dd"  CssClass="form-control" runat="server" TextMode="Number"
                     data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" 
...
<%--                      <div class="col-md-12  d-flex flex-row mt-3">
                        ...
                        <label class="form-label" for="basic-default-password12">Image </label>
                             ...
                             <asp:FileUpload ID="tb_emp_image"  CssClass="form-control" 
                                 runat="server" 
                                  data-bs-toggle="tooltip"
                                  data-bs-offset="0,4" 
                                 data-bs-placement="top" 
                                 data-bs-html="true" 
                                 title="employee image upload"
                                  required />  
                        </div>
                      </div>--%>
                    <%--  --%>
